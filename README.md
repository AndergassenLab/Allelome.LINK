...
## 3.2 Input flags for Allelome.PRO.v2.0:
...
To access the resource generated by *Hasenbein T., Andergassen, D. et al.*, use JSON files for mice and human samples from the ./resource/ folder. 
