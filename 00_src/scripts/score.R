...
## Creation: 04.2021
## Scoring script as part of the Allelome.PRO project. Steps comprise pileup filtering, read counts, locus table generation, allelic scoring, calculation of allelic ratio and full locus table generation
## Removed base quality filtering l.57  & fil$quality >=20
